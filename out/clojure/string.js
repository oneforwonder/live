...
{{
var G__10144 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10144;
continue;
}
} else
...
{var pred__10148 = cljs.core._EQ_;var expr__10149 = limit;if(cljs.core.truth_(pred__10148.call(null,1,expr__10149)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10148.call(null,2,expr__10149)))
...
var G__10151 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10152 = (limit__$1 - 1);
var G__10153 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10151;
limit__$1 = G__10152;
parts = G__10153;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10155 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10155))
{var replacement_10156 = temp__4124__auto___10155;buffer.append([cljs.core.str(replacement_10156)].join(''));
} else
{buffer.append(ch);
}
{
var G__10157 = (index + 1);
index = G__10157;
continue;
}
}
